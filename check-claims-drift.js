...
check("No Overclaiming Language in Program Output (CLI, workers, launcher)", () => {
  ...
  const files = ['seam-hpc-cli.js', 'aa2fr-worker.js', 'run-seam-search.bat', 'h6-image-sweep.js', 'morphism-scan.js', 'sft-container.js', 'additive-sweep.js', 'extension-table.js', 'sanalab-run.js'];
  const offences = [];
