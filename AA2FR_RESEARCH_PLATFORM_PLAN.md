...
### RQ1: Why do AA2FR words eventually become difficult to extend?
...
### RQ2: Which local structures correlate most strongly with dead ends?
...
### RQ3: Which Parikh imbalance predicts future collisions?
...
### RQ4: Are there recurring "trap motifs" that appear before every failure?
...
### RQ5: Can the search algorithm learn better branching heuristics from previous searches?
...
### RQ6: Can successful search paths be clustered into families?
...
### RQ7: Can we automatically classify obstruction types?
...
### RQ8: Can AA2FR be characterized mathematically rather than computationally?

> This is the long-term research goal. Everything else serves this question.

#### What We Want to Understand
Can we move beyond "search for words" toward "understand the structure"?

#### Potential Discoveries
- A new invariant that all long AA2FR words share
- A potential function that predicts extendability
- A trap classification theorem
- A new morphism that generates arbitrarily long AA2FR words
- A mathematical characterization of the AA2FR language

#### How the Platform Supports This
- RQ1–RQ4 produce the empirical evidence
- RQ5–RQ6 reveal structural patterns
- RQ7 classifies the obstruction landscape
- Together they may suggest conjectures that can be proved mathematically

#### Source Material
- Mattila 2002: Polynomial inequality method → algebraic approach to construction
- Enhanced Carpi's Test: Verification of morphism-based generation
- Keränen TCS 2009: "Powerful" substitutions → path toward infinite words
...
### Phase 1 — Instrumented Search Engine (Foundation)

> Without data, no research is possible.

| Task | Serves |
|------|--------|
| Web Worker architecture + postMessage API | All RQs |
| Prefix-sum Parikh + integer packing | Performance |
| Strategy layer (fixed / Gavrilenko / rotation) | RQ3, RQ5 |
| Per-step analytics data collection | All RQs |
| Evolution event stream | Evolution Replay |
| RQ0 validation suite | RQ0 |

**Output**: Search engine that collects research data on every step.
...
**RQ0 → RQ1+RQ3 → RQ7+RQ2 → RQ4 → RQ5 → RQ6 → RQ8**

- RQ0 first — without verified validator, all data is unreliable
- RQ1+RQ3 together — branching factor and Parikh balance produce data that feeds all other RQs; cheapest to instrument
- RQ7+RQ2 together — obstruction classification and suffix analysis use the same collected data
- RQ4 after — trap motif mining requires accumulated dead-end data from RQ2
- RQ5 later — adaptive learning needs baseline data from fixed strategy
- RQ6 last — clustering requires many successful long searches
- RQ8 is continuous — not a feature but the cumulative result of everything else
